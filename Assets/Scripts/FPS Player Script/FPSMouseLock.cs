...
public class FPSMouseLock : MonoBehaviour {
    ...
    private float currentSenstivity_X = 1.5f;
    private float currentSenstivity_Y = 1.5f;
    ...
    void HandleRotation()
    {
        if ( currentSenstivity_X != mouseSensitivity || currentSenstivity_Y != mouseSensitivity)
        {
            currentSenstivity_X = currentSenstivity_Y = mouseSensitivity;

        }
        sensitivity_X = currentSenstivity_X;
        sensitivity_Y = currentSenstivity_Y;
